...
case $1 in
	...
	toxicwaste | tw)
		...
		;;
	oil | o)
		SOURCE_SHADER=$DIR"/share/SARndbox-1.6/Shaders/Fluids/SurfaceAddWaterColor-Oil.fs"
		echo "waterAttenuation 0.02" > $PIPE_PATH
		;;
	halftone | h)
		SOURCE_SHADER=$DIR"/share/SARndbox-1.6/Shaders/Fluids/SurfaceAddWaterColor-Halftone.fs"
		echo "waterAttenuation 0.05" > $PIPE_PATH
		;;
	experimental | exp)
		SOURCE_SHADER=$DIR"/share/SARndbox-1.6/Shaders/Fluids/SurfaceAddWaterColor-Experimental.fs"
